...
var _t = class {
  ...
  setup() {
    ...
    e3 && (E(!_t.isSetUp, "Cannot have two Touch backends at the same time."), _t.isSetUp = true, this.addEventListener(e3, "start", this.getTopMoveStartHandler()), this.addEventListener(e3, "start", this.handleTopMoveStartCapture, true), this.addEventListener(e3, "move", this.handleTopMove), this.addEventListener(e3, "move", this.handleTopMoveCapture, true), this.addEventListener(e3, "end", this.handleTopMoveEndCapture, true), this.options.enableMouseEvents && !this.options.ignoreContextMenu && this.addEventListener(e3, "contextmenu", this.handleTopMoveEndCapture), this.options.enableKeyboardEvents && this.addEventListener(e3, "keydown", this.handleCancelOnEscape, true));
  }
  teardown() {
    const e3 = this.options.rootElement;
    e3 && (_t.isSetUp = false, this._mouseClientOffset = {}, this.removeEventListener(e3, "start", this.handleTopMoveStartCapture, true), this.removeEventListener(e3, "start", this.handleTopMoveStart), this.removeEventListener(e3, "move", this.handleTopMoveCapture, true), this.removeEventListener(e3, "move", this.handleTopMove), this.removeEventListener(e3, "end", this.handleTopMoveEndCapture, true), this.options.enableMouseEvents && !this.options.ignoreContextMenu && this.removeEventListener(e3, "contextmenu", this.handleTopMoveEndCapture), this.options.enableKeyboardEvents && this.removeEventListener(e3, "keydown", this.handleCancelOnEscape, true), this.uninstallSourceNodeRemovalObserver());
  }
...
}, onPieceDrop: R2 = () => true, onPromotionPieceSelect: A2, onSquareClick: q2 = () => {
}, onSquareRightClick: _2 = () => {
}, position: z2 = "start", promotionDialogVariant: H2 = "default", promotionToSquare: B2 = null, showBoardNotation: W2 = true, showPromotionDialog: U2 = false, snapToCursor: F2 = true, autoPromoteToQueen: $2 = false }, V2) => {
  const [Y2, K2] = (0, import_react.useState)(Kt(z2)), [X2, G2] = (0, import_react.useState)({ removed: {}, added: {} }), [Q2, J2] = (0, import_react.useState)(void 0), [Z2, ee2] = (0, import_react.useState)(U2 && !$2), [te2, re2] = (0, import_react.useState)(null), [ne2, oe2] = (0, import_react.useState)(B2), [ie2, se2] = (0, import_react.useState)([]), ae2 = (0, import_react.useRef)(ie2), [ce2, ue2] = (0, import_react.useState)(), [le2, de2] = (0, import_react.useState)(Object.assign(Object.assign({}, Vt), b2)), [he2, ge2] = (0, import_react.useState)(false), [fe2, pe2] = (0, import_react.useState)(), [ve2, me2] = (0, import_react.useState)(false);
  (0, import_react.useImperativeHandle)(V2, () => ({ clearPremoves(e3 = true) {
    Ce2(e3);
  } })), (0, import_react.useEffect)(() => {
    de2(Object.assign(Object.assign({}, Vt), b2));
  }, [b2]), (0, import_react.useEffect)(() => {
    ee2(U2), oe2(B2);
  }, [B2, U2]), (0, import_react.useEffect)(() => {
    var e3, r3, n3;
    Te2();
    const i2 = Kt(z2), s3 = function(e4, t3) {
    ...
    }(Y2, i2), a2 = (null === (e3 = Object.keys(s3.added)) || void 0 === e3 ? void 0 : e3.length) <= 2 ? null === (n3 = null === (r3 = Object.entries(s3.added)) || void 0 === r3 ? void 0 : r3[0]) || void 0 === n3 ? void 0 : n3[1][0] : void 0;
    if (ve2)
      K2(i2), me2(false), o2 && De2(a2), fe2 && clearTimeout(fe2);
    else if (he2)
      K2(i2), me2(false), o2 && De2(a2);
    else {
      !function(e5) {
        let t3 = false;
      ...
      }(i2) || void 0 === Q2 ? J2(void 0) : J2(a2), G2(s3), me2(true);
      const e4 = setTimeout(() => {
        K2(i2), me2(false), o2 && De2(a2);
      }, t2);
      pe2(e4);
    }
    return ge2(false), I2(i2), Oe2(), () => {
      clearTimeout(fe2);
    };
  }, [z2]);
  const { arrows: ye2, newArrow: be2, clearArrows: Oe2, drawNewArrow: we2, onArrowDrawEnd: Se2 } = Qt(d2, r2, k2);
  function De2(e3) {
    if (0 === ae2.current.length)
      return;
    const t3 = ae2.current[0];
    if (void 0 !== t3.piece[0] && t3.piece[0] !== e3 && R2.length) {
      J2(t3.piece[0]), ge2(true);
      if (R2(t3.sourceSq, t3.targetSq, t3.piece)) {
        const e4 = [...ae2.current];
        e4.shift(), ae2.current = e4, se2([...e4]);
      } else
        Ce2();
    }
  }
  function Ce2(e3 = true) {
    e3 && J2(void 0), ae2.current = [], se2([]);
  }
  function Te2() {
    re2(null), oe2(null), ee2(false);
  }
  const Ee2 = { animationDuration: t2, arePiecesDraggable: n2, arePremovesAllowed: o2, boardOrientation: s2, boardWidth: c2, customArrowColor: h2, customBoardStyle: g2, customDarkSquareStyle: v2, customDropSquareStyle: m2, customLightSquareStyle: y, customPremoveDarkSquareStyle: O2, customPremoveLightSquareStyle: w2, customSquare: S2, customSquareStyles: D2, id: T2, isDraggablePiece: E2, onDragOverSquare: L2, onMouseOutSquare: P2, onMouseOverSquare: x2, onPieceClick: M2, onPieceDragBegin: N2, onPieceDragEnd: j2, onPieceDrop: R2, onPromotionPieceSelect: A2, onSquareClick: q2, showBoardNotation: W2, snapToCursor: F2, promotionDialogVariant: H2, arrows: ye2, newArrow: be2, onArrowDrawEnd: Se2, chessPieces: le2, clearArrows: Oe2, drawNewArrow: we2, clearCurrentRightClickDown: function() {
    ue2(void 0);
  }, currentPosition: Y2, handleSetPosition: function(e3, t3, r3, n3) {
    if (e3 === t3)
      return;
    if (Oe2(), o2 && ve2 || o2 && (Q2 === r3[0] || ae2.current.filter((e4) => e4.piece[0] === r3[0]).length > 0)) {
      const n4 = [...ae2.current];
      return n4.push({ sourceSq: e3, targetSq: t3, piece: r3 }), ae2.current = n4, se2([...n4]), void Te2();
    }
    if (!o2 && ve2)
      return;
    const i2 = Object.assign({}, Y2);
    if (ge2(!!n3), J2(r3[0]), R2.length) {
      R2(e3, t3, r3) || Ce2();
    } else
      "trash" !== C2 || t3 || delete i2[e3], delete i2[e3], i2[t3] = r3, K2(i2);
    Te2(), I2(i2);
  }, isWaitingForAnimation: ve2, lastPieceColour: Q2, onRightClickDown: function(e3) {
    ue2(e3);
  }, onRightClickUp: function(e3) {
    if (ce2) {
      if (ce2 === e3)
        return ue2(void 0), l2 && Ce2(false), void _2(e3);
    } else
      ue2(void 0);
  }, positionDifferences: X2, promoteFromSquare: te2, promoteToSquare: ne2, premoves: ie2, setPromoteFromSquare: re2, setPromoteToSquare: oe2, setShowPromoteDialog: ee2, showPromoteDialog: Z2, autoPromoteToQueen: $2, currentRightClickDown: ce2 };
  return (0, import_jsx_runtime.jsx)(Jt.Provider, Object.assign({ value: Ee2 }, { children: u2 }));
});
...
function ir({ square: t2, squareColor: r2, setSquares: n2, squareHasPremove: o2, children: s2 }) {
  const a2 = (0, import_react.useRef)(null), { boardWidth: c2, boardOrientation: u2, clearArrows: l2, currentPosition: d2, customBoardStyle: h2, customDarkSquareStyle: g2, customDropSquareStyle: p2, customLightSquareStyle: v2, customPremoveDarkSquareStyle: m2, customPremoveLightSquareStyle: y, customSquare: b2, customSquareStyles: O2, handleSetPosition: w2, isWaitingForAnimation: S2, lastPieceColour: D2, onDragOverSquare: C2, onMouseOutSquare: T2, onMouseOverSquare: E2, onPieceDrop: I2, onRightClickDown: k2, onRightClickUp: L2, onSquareClick: P2, setPromoteFromSquare: x2, setPromoteToSquare: M2, setShowPromoteDialog: N2, autoPromoteToQueen: j2, currentRightClickDown: R2, drawNewArrow: A2, onArrowDrawEnd: q2 } = Zt(), [{ isOver: _2 }, z2] = it(() => ({ accept: "piece", drop: H2, collect: (e3) => ({ isOver: !!e3.isOver() }) }), [t2, d2, I2, S2, D2]);
  function H2(e3) {
    Math.abs(e3.square[0].charCodeAt(0) - t2[0].charCodeAt(0)) <= 1 && ("wP" === e3.piece && "8" === t2[1] || "bP" === e3.piece && "1" === t2[1]) ? j2 ? w2(e3.square, t2, "8" === t2[1] ? "wQ" : "bQ") : (x2(e3.square), M2(t2), N2(true)) : w2(e3.square, t2, e3.piece, true);
  }
  (0, import_react.useEffect)(() => {
    if (a2.current) {
  ...
  const B2 = Object.assign(Object.assign(Object.assign(Object.assign({}, cr(t2, u2, h2)), "black" === r2 ? g2 : v2), o2 && ("black" === r2 ? m2 : y)), _2 && p2);
  return (0, import_jsx_runtime.jsx)("div", Object.assign({ ref: z2, style: B2, "data-square-color": r2, "data-square": t2, onMouseOver: (e3) => {
    2 === e3.buttons && R2 && A2(R2, t2), e3.relatedTarget && e3.currentTarget.contains(e3.relatedTarget) || E2(t2);
  }, onMouseOut: (e3) => {
    e3.relatedTarget && e3.currentTarget.contains(e3.relatedTarget) || T2(t2);
  }, onMouseDown: (e3) => {
    2 === e3.button && k2(t2);
  }, onMouseUp: (e3) => {
    2 === e3.button && (R2 && q2(R2, t2), L2(t2));
  }, onDragEnter: () => C2(t2), onClick: () => {
    P2(t2), l2();
  }, onContextMenu: (e3) => {
    e3.preventDefault();
  } }, { children: (0, import_jsx_runtime.jsx)(b2, "string" == typeof b2 ? Object.assign({ ref: a2, style: Object.assign(Object.assign(Object.assign({}, ar(c2)), sr), !o2 && (null == O2 ? void 0 : O2[t2])) }, { children: s2 }) : Object.assign({ ref: a2, square: t2, squareColor: r2, style: Object.assign(Object.assign(Object.assign({}, ar(c2)), sr), !o2 && (null == O2 ? void 0 : O2[t2])) }, { children: s2 })) }));
}
...
function hr({ option: t2 }) {
  ...
  return (0, import_jsx_runtime.jsx)("div", Object.assign({ onClick: () => {
    (null == l2 ? void 0 : l2.length) ? l2(t2) : u2(d2, h2, t2);
